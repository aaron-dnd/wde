...
const directors = [
  ...
  {
    name: "MR. B. AARON AMIT",
    role: "Co-Founder & Technology Lead",
    image: "/team/director-two.png",
   bio: "Co-built the studio from the ground up - the systems, the process, the standard every event is held to. Always working behind the scenes, so nothing is ever left to chance.",
  },
   {
    name: "MR. KARTHIK B",
    role: "Partner, Technical & Production",
